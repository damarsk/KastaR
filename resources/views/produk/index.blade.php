                        ...
                        <div class="bgc-white bd bdrs-3 p-20 mB-20">
                            ...
                            <div class="btn-group" style="float: right; margin-bottom: 10px;">
                                ...
                                <button onclick="cetakBarcode(' {{ route('produk.cetakBarcode') }} ')"
                                    class="btn cur-p btn-info btn-color btn-sm"><i class="fa fa-barcode"></i> Cetak
                                    Barcode</button>
                            </div>
    ...
    <script>
        ...
        function cetakBarcode(url) {
            if ($('input:checked').length < 1) {
                alert('Pilih data yang akan dicetak barcode');
                return;
            } else if ($('input:checked').length < 3) {
                alert('Pilih minimal 3 data yang akan dicetak barcode');
                return;
            } else {
                $('.form-produk')
                .attr('target', '_blank')
