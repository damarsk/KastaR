@extends('layouts.app')
@section('title', 'KastaR - Dashboard')
@section('styles')
    <style>
        #loader {
                        ...
                        <div class="masonry-item col-md-6"><!-- #Monthly Stats ==================== -->
                            <div class="bd bgc-white">
                                <div class="layers">
                                    ...
                                    <div class="layer w-100 p-20"><canvas id="line-chart" height="220"></canvas>
                                    </div>
                                    <div class="layer bdT p-20 w-100">
                                        <div class="peers ai-c jc-c gapX-20">
                                            ...
                                            <div class="peer fw-600"><span class="fsz-def fw-600 mR-10 c-grey-800">2%
                                                    <i class="fa fa-level-down c-red-500"></i></span> <small
                                            ...
                                            <div class="peer fw-600"><span class="fsz-def fw-600 mR-10 c-grey-800">8%
                                                    <i class="fa fa-level-down c-red-500"></i></span> <small
                                ...
                                <div class="layers">
                                    ...
                                    <div class="layer w-100">
                                        <div class="peers peers-greed ai-fs ta-c">
                                            ...
                                            <div class="peer">
                                                <h6 class="mB-10">WED</h6><canvas class="partly-cloudy-day"
                                                    width="30" height="30"></canvas><span
